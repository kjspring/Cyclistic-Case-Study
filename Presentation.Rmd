...
## What are the differences between casual users and members?
...
- Targeted marketing toward casual users
  ...
  - Time: 
	- Day of the week
	- Time of the day
	- Long versus short trip duration
...
![](Presentation\\img\\climate_chicago.png){width=50%}
...
## 6. Diving into the Data {.columns-2 .smaller}
...
![](Presentation\\plots\\total_rides_usertype.png)
